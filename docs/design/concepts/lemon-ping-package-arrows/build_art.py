...
for y0 in (1,13):
 # Two staggered, opposing arrows; hard pixel edges and no label background.
 top=y0*2+10
 ink='#59615b'
 d.line((78,top,87,top),fill=ink,width=2)
 d.polygon([(85,top-2),(89,top),(85,top+3)],fill=ink)
 bottom=top+7
 d.line((81,bottom,90,bottom),fill=ink,width=2)
 d.polygon([(83,bottom-2),(79,bottom),(83,bottom+3)],fill=ink)
...
(OUT/'README.md').write_text('柠檬黄诊断包往返箭头方案：两个错开的深灰短箭头，上方向右、下方向左，无背景、无描边和端点。只印在东西两个无胶带侧面，保持现有箱体颜色、模型与 UV。使用半模型单位的硬边像素网格，原有箱体纹素不变。此前图标另存，未修改正式游戏资源。\n')
